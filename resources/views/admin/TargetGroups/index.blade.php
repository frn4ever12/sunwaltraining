...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">टार्गेट समूह सूची</h3>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('admin.target-group.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.target-group.edit', $data->id) }}" class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger btn-sm deleteBtn"
                                                data-route="{{ route('admin.target-group.destroy', $data->id) }}">
