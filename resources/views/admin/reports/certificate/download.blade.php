...
@section('content')
    ...
    <div class="card my-4">
        ...
        <div id="filterForm" class="collapse card-body">
            <form method="GET" id="filterData" action="{{ route('admin.reports.certificate.download') }}">
                <div class="row g-2">
                    ...
                    <div class="form-group col-md-4 col-12">
                        <a href="{{ route('admin.reports.certificate.download') }}" class="btn btn-secondary w-100">रिसेट</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card shadow-sm my-4" id="printSection">
        <div class="card-body">
            ...
            <h2 class="fw-bold mt-4">प्रमाणपत्र डाउनलोड प्रतिवेदन</h2>
