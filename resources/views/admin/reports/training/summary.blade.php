...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">तालिम सारांश</h3>
    ...
    <div class="card my-4">
        ...
        <div id="filterForm" class="collapse card-body">
            <form method="GET" id="filterData" action="{{ route('reports.training.summary') }}">
                <div class="row g-2">
                    ...
                    <div class="form-group col-md-6 col-12">
                        <a href="{{ route('reports.training.summary') }}" class="btn btn-secondary w-100">रिसेट</a>
                    </div>
                </div>
            </form>
        </div>
