...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">तालिम सूची</h3>
    ...
    <div class="card my-4">
        ...
        <div id="filterForm" class="collapse card-body">
            <form method="GET" id="filterData" action="{{ route('reports.training.list') }}">
                <div class="row g-2">
                    ...
                    <div class="form-group col-md-3 col-12">
                        <a href="{{ route('reports.training.list') }}" class="btn btn-secondary w-100">रिसेट</a>
                    </div>
                </div>
            </form>
        </div>
