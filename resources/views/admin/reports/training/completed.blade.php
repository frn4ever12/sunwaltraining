...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">सम्पन्न तालिम</h3>
    ...
    <div class="card my-4">
        ...
        <div id="filterForm" class="collapse card-body">
            <form method="GET" id="filterData" action="{{ route('admin.reports.training.completed') }}">
                <div class="row g-2">
                    ...
                    <div class="form-group col-md-4 col-12">
                        <a href="{{ route('admin.reports.training.completed') }}" class="btn btn-secondary w-100">रिसेट</a>
                    </div>
                </div>
            </form>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="completedTrainingTable">
                    <thead>
                        <tr>
                            <th>क्र.सं.</th>
                            <th>तालिमको नाम</th>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#completedTrainingTable').DataTable({
                language: {
