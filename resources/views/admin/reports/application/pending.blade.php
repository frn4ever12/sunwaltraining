...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">प्रतीक्षामा रहेका आवेदन</h3>
        <ul class="mb-3 breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">प्रतीक्षामा रहेका आवेदन</a>
            </li>
        </ul>
    </div>
    ...
    <div class="card my-4">
        ...
        <div id="filterForm" class="collapse card-body">
            <form method="GET" id="filterData" action="{{ route('reports.application.pending') }}">
                <div class="row g-2">
                    ...
                    <div class="form-group col-md-4 col-12">
                        <a href="{{ route('reports.application.pending') }}" class="btn btn-secondary w-100">रिसेट</a>
                    </div>
                </div>
            </form>
        </div>
