...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">अस्वीकृत आवेदन</h3>
    ...
    <div class="card my-4">
        ...
        <div id="filterForm" class="collapse card-body">
            <form method="GET" id="filterData" action="{{ route('admin.reports.application.rejected') }}">
                <div class="row g-2">
                    ...
                    <div class="form-group col-md-4 col-12">
                        <a href="{{ route('admin.reports.application.rejected') }}" class="btn btn-secondary w-100">रिसेट</a>
                    </div>
                </div>
            </form>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-bordered" id="rejectedApplicationsTable">
                    <thead>
                        <tr>
                            <th>क्र.सं.</th>
                            <th>आवेदन नं.</th>
