...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">स्कीम</h3>
        <ul class="mb-3 breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.scheme.index') }}">स्कीम</a>
            </li>
            <li class="separator">
                <i class="icon-arrow-right"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ isset($scheme->id) ? 'सम्पादन गर्नुहोस्' : 'नयाँ थप्नुहोस्' }}</a>
            </li>
        </ul>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form
                action="{{ isset($scheme->id) ? route('admin.scheme.update', $scheme->id) : route('admin.scheme.store') }}"
                ...
                <div class="mb-3 row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('title_np') is-invalid @enderror" id="title_np"
                            name="title_np" value="{{ old('title_np', $scheme->title_np ?? '') }}" placeholder="शिर्षक">
                        @error('title_np')
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('title_eng') is-invalid @enderror" id="title_eng"
                            name="title_eng" value="{{ old('title_eng', $scheme->title_eng ?? '') }}" placeholder="शिर्षक">
                        @error('title_eng')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        @if (isset($scheme->document))
                            <a href="{{ asset('files/' . $scheme->document) }}" target="_blank"
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('miti_bs') is-invalid @enderror" id="miti_bs"
                            name="miti_bs" value="{{ old('miti_bs', $scheme->miti_bs ?? '') }}" placeholder="YYYY-MM-DD">
                        @error('miti_bs')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('miti_ad') is-invalid @enderror" id="miti_ad"
                            name="miti_ad" value="{{ old('miti_ad', $scheme->miti_ad ?? '') }}" placeholder="YYYY-MM-DD"
                            readonly>
                        @error('miti_ad')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3 row">
                    <div class="col-md-12">
                        ...
                        <textarea class="col-xs-10 col-sm-5 form-control ckeditor" rows="15" id="description" name="description">
                            {{ old('description', $scheme->description ?? '') }}
                        </textarea>
                    </div>
                </div>
                <div class="mb-3 row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                            ...
                            <option value="1" {{ old('status', $scheme->status ?? '') == '1' ? 'selected' : '' }}>
                                सक्रिय
                            </option>
                            <option value="0" {{ old('status', $scheme->status ?? '') == '0' ? 'selected' : '' }}>
                                निष्क्रिय
                            </option>
                        </select>
                        @error('status')
                ...
                <div class="d-flex justify-content-start">
                    <button type="submit" class="btn btn-primary">
                        ...
                        {{ isset($scheme->id) ? 'अपडेट गर्नुहोस्' : 'सुरक्षित गर्नुहोस्' }}
                    </button>
                </div>
            </form>
        </div>
