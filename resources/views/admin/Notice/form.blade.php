...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">नोटिस</h3>
        <ul class="mb-3 breadcrumbs">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.notice.index') }}">नोटिस </a>
            </li>
            <li class="separator">
                <i class="icon-arrow-right"></i>
            </li>
            <li class="nav-item">
                <a href="#">{{ isset($notice->id) ? 'सम्पादन गर्नुहोस्' : 'नयाँ थप्नुहोस्' }}</a>
            </li>
        </ul>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form
                action="{{ isset($notice->id) ? route('admin.notice.update', $notice->id) : route('admin.notice.store') }}"
                ...
                <div class="mb-3 row">
                    <div class="col-md-6 col-sm-12">
                        <label for="title_np" class="form-label ">नोटिस शिर्षक (नेपाली)</label>
                        <input type="text" class="form-control @error('title_np') is-invalid @enderror" id="title_np"
                            name="title_np" value="{{ old('title_np', $notice->title_np ?? '') }}" placeholder="शिर्षक">
                        @error('title_np')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <label for="title_eng" class="form-label ">नोटिस शिर्षक (अंग्रेजी)</label>
                        <input type="text" class="form-control @error('title_eng') is-invalid @enderror" id="title_eng"
                            name="title_eng" value="{{ old('title_eng', $notice->title_eng ?? '') }}" placeholder="शिर्षक">
                        @error('title_eng')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3 row">
                    <div class="col-md-6 col-sm-12">
                        ...
                        @if (isset($notice->document))
                            <a href="{{ asset('files/' . $notice->document) }}" target="_blank"
                    ...
                    <div class="col-md-3 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('miti_bs') is-invalid @enderror" id="miti_bs"
                            name="miti_bs" value="{{ old('miti_bs', $notice->miti_bs ?? '') }}" placeholder="YYYY-MM-DD">
                        @error('miti_bs')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-3 col-sm-12">
                        ...
                        <input type="text" class="form-control @error('miti_ad') is-invalid @enderror" id="miti_ad"
                            name="miti_ad" value="{{ old('miti_ad', $notice->miti_ad ?? '') }}" placeholder="YYYY-MM-DD"
                            readonly>
                        @error('miti_ad')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="d-flex justify-content-start">
                    <button type="submit" class="btn btn-primary">
                        ...
                        {{ isset($notice->id) ? 'अपडेट गर्नुहोस्' : 'सुरक्षित गर्नुहोस्' }}
                    </button>
                </div>
            </form>
        </div>
