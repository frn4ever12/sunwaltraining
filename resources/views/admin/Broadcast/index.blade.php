...
@section('content')
    <div class="page-header">
        <h3 class="mb-3 fw-bold">प्रसारित सन्देशको सूची</h3>
                            ...
                            <tbody>
                                @foreach ($datas as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.broadcast.edit', $data->id) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger btn-sm deleteBtn"
                                                data-route="{{ route('admin.broadcast.destroy', $data->id) }}">
